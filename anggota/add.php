        ...
        <div class="inputs w-full max-w-2xl p-6 mx-auto">
            <form action="store.php" method="POST" enctype="multipart/form-data" class="mt-6 border-t border-gray-400 pt-4">
                <div class="w-full md:w-full px-3 mb-6">
                    ...
                    <input id="kode_anggota" value="" type="text" placeholder="nama anggota" class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500">
                </div>
                <div class="w-full md:w-full px-3 mb-6">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                        Nama
                    </label>
                    <input id="nama" value="" type="text" name="nama" placeholder="nama anggota" class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500">
                </div>
                <div class="w-full md:w-full px-3 mb-6">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                        Jenis Kelamin
                ...
                <div class="w-full md:w-full px-3 mb-6">
                    ...
                    <input id="alamat" value="" type="text" name="alamat" placeholder="alamat anggota" class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500">
                </div>
                <div class="w-full md:w-full px-3 mb-6">
