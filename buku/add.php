            ...
            <div class="">
                <form action="store.php" method="POST" enctype="multipart/form-data" class="mt-6 border-t border-gray-400 pt-4">
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input id="kode_buku" value="" type="text" class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500" name="kode_buku" placeholder="kode buku">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
                        <label for="judul" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Judul</label>
                        <input id="judul" value="" type="text" class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500 " name="judul" placeholder="judul buku">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">

                        <label for="penerbit" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Penerbit</label>
                        <input id="penerbit" value="" type="text" class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500 " name="penerbit" placeholder="penerbit buku">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
                        <label for="tahun_terbit" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Tahun Terbit</label>
                        <input id="tahun_terbit" value="" type="text" class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500 " name="tahun_terbit" placeholder="tahun terbit buku">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
